<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminDiscounts&amp;action=pjActionUpdate" method="post" id="frmUpdateDiscount" class="form pj-form" autocomplete="off">
	<input type="hidden" name="discount_update" value="1" />
	<input type="hidden" name="id" value="<?php echo $tpl['arr']['id'];?>" />
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		<h4 class="modal-title" id="myModalDiscountLabel"><?php __('infoUpdateDiscountTitle');?></h4>
	</div>
	<div class="modal-body">
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="input-group"> 
						<input type="text" name="date_from" id="date_from" class="form-control datepick required" value="<?php echo $date_from;?>" readonly="readonly" data-msg-required="<?php __('pj_field_required');?>" /> 
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="input-group"> 
						<input type="text" name="date_to" id="date_to" class="form-control datepick required" value="<?php echo $date_to;?>" readonly="readonly" data-msg-required="<?php __('lblFieldRequired');?>" />
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					</div>
                </div>
            </div>
        ...
        <div class="form-group m-t-md">
        	<?php foreach($apply_conditions as $k => $v) { ?>
	            <div class="m-b-xs">
	            	<label class="control-label"><input type="radio" class="i-checks" name="condition" value="<?php echo $k;?>" <?php echo $k == $tpl['arr']['condition'] ? ' checked="checked"' : null;?>> <span class="m-l-xs"><?php echo $v;?></span></label>
	            </div>
			<?php } ?>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
					<div class="input-group">
						<input class="form-control text-right required number" min="0" data-msg-min="<?php __('pj_field_negative_number_err');?>" type="text" id="discount" name="discount" value="<?php echo $tpl['arr']['discount'];?>" data-msg-required="<?php __('pj_field_required');?>" data-msg-number="<?php __('prices_invalid_price', false, true);?>">
						<span class="input-group-addon"><strong id="icon_type"><?php echo $tpl['arr']['type'] == 'amount' ? pjCurrency::getCurrencySign($tpl['option_arr']['o_currency'], false) : '%'; ?></strong></span>
					</div>
				</div>
            </div>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <select class="form-control required" name="type" id="type" data-msg-required="<?php __('pj_field_required');?>">
						...
						{
							?><option value="<?php echo $k; ?>" <?php echo $k == $tpl['arr']['type'] ? ' selected="selected"' : NULL;?> data-sign="<?php echo $k == 'amount' ? pjCurrency::getCurrencySign($tpl['option_arr']['o_currency'], false) : '%'; ?>"><?php echo $v; ?></option><?php
						}
						?>
                    </select>
                </div>
		...
		<div class="form-group">
	        ...
	        <select class="form-control required" name="options" id="options" data-msg-required="<?php __('pj_field_required');?>">
				...
				{
					?><option value="<?php echo $k; ?>" <?php echo $k == $tpl['arr']['options'] ? ' selected="selected"' : NULL;?>><?php echo stripslashes($v); ?></option><?php
				}
				?>
	        </select>
       </div>
       ...
       <div class="form-group optionsBox earlyBox">
        	...
        	<input class="touchspin3 form-control abOptions" type="text" id="early_days" name="early_days" value="<?php echo $tpl['arr']['early_days'];?>" data-msg-required="<?php __('pj_field_required');?>" />
       </div>
       ...
       <div class="form-group optionsBox personsBox">
        	...
        	<div class="row">
        		<div class="col-xs-6">
        			<input class="touchspin3 form-control abOptions" type="text" id="min_persons" name="min_persons" value="<?php echo $tpl['arr']['min_persons'];?>" data-msg-required="<?php __('pj_field_required');?>" />
        			<small class="help-block m-b-none"><?php __('lblMinimum');?></small>
        		</div>
        		<div class="col-xs-6">
        			<input class="touchspin3 form-control abOptions" type="text" id="max_persons" name="max_persons" value="<?php echo $tpl['arr']['max_persons'];?>" data-msg-required="<?php __('pj_field_required');?>" />
       ...
       <div class="form-group optionsBox durationBox">
        	...
        	<div class="row">
        		<div class="col-xs-6">
        			<input class="touchspin3 form-control abOptions" type="text" id="min_duration" name="min_duration"  value="<?php echo $tpl['arr']['min_duration'];?>" data-msg-required="<?php __('pj_field_required');?>" />
        			<small class="help-block m-b-none"><?php __('lblMinimum');?></small>
        		</div>
        		<div class="col-xs-6">
        			<input class="touchspin3 form-control abOptions" type="text" id="max_duration" name="max_duration"  value="<?php echo $tpl['arr']['max_duration'];?>" data-msg-required="<?php __('pj_field_required');?>" />
        			<small class="help-block m-b-none"><?php __('lblMaximum');?></small>
        		</div>
        	</div>
       </div>
